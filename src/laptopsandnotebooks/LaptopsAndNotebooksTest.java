...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Ankur");
        sendTextToElement(By.id("input-payment-lastname"), "Rathod");
        sendTextToElement(By.id("input-payment-email"), "ankur@gmail.com");
